...
$('body').prepend(`
    ...
    <form id="formAlertJQ">
    <h2 class="mainTittle">DÍA DE SUERTE</h2>
...
// ANIMACIONES DESAFÍO 13!!!!!!!!

$('#formAlertJQ').submit(function (e){
    e.preventDefault();
    $('label').css('color', 'grey');
    $('.mainTittle').text('¡GRACIAS, POR TU RESPUESTA!');
    $('.mainTittle').animate({opacity: '0.5', marginTop: '100px'}, 1000, function (){
        $('#formAlertJQ').fadeOut(1000);
    }
    );
